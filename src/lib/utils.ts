...
import { isValidStellarAddress as isValidStellarAddressWithChecksum } from "./stellar"
...
export const isValidStellarAddress = (addr: string): boolean => isValidStellarAddressWithChecksum(addr)
